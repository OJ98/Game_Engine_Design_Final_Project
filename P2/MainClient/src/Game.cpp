...
Game::~Game() {
	...
	delete this->platform_wall_vert1;
	delete this->platform_wall_vert2;
	delete this->platform_wall_vert3;
	delete this->platform_wall_vert4;
	...
	for (auto j = this->wall_platform_pointers.begin(); j != this->wall_platform_pointers.end(); ++j) {
		delete (*j);
	}
...
void Game::initPlatforms() {
	...
	this->platform_base->setFillColor(sf::Color::Green);
	this->platform_base->setPosition(1, 500);
	this->platform_base->setMoveDistance(400.f);

	this->platform_wall_vert1 = new Platform();
	this->platform_wall_vert1->setVelocity(0.f);
	this->platform_wall_vert1->setSize(sf::Vector2f(100,200));
	this->platform_wall_vert1->setFillColor(sf::Color::Green);
	this->platform_wall_vert1->setPosition(400, 1);
	this->platform_wall_vert1->setMoveDistance(400.f);
	this->wall_platform_pointers.push_back(this->platform_wall_vert1);

	this->platform_wall_vert2 = new Platform();
	this->platform_wall_vert2->setVelocity(0.f);
	this->platform_wall_vert2->setSize(sf::Vector2f(100,200));
	this->platform_wall_vert2->setFillColor(sf::Color::Green);
	this->platform_wall_vert2->setPosition(400, 350);
	this->platform_wall_vert2->setMoveDistance(400.f);
	this->wall_platform_pointers.push_back(this->platform_wall_vert2);

	this->platform_wall_vert3 = new Platform();
	this->platform_wall_vert3->setVelocity(0.f);
	this->platform_wall_vert3->setSize(sf::Vector2f(100, 250));
	this->platform_wall_vert3->setFillColor(sf::Color::Green);
	this->platform_wall_vert3->setPosition(700, 1);
	this->platform_wall_vert3->setMoveDistance(400.f);
	this->wall_platform_pointers.push_back(this->platform_wall_vert3);

	this->platform_wall_vert4 = new Platform();
	this->platform_wall_vert4->setVelocity(0.f);
	this->platform_wall_vert4->setSize(sf::Vector2f(100,250));
	this->platform_wall_vert4->setFillColor(sf::Color::Green);
	this->platform_wall_vert4->setPosition(700, 400);
	this->platform_wall_vert4->setMoveDistance(400.f);
	this->wall_platform_pointers.push_back(this->platform_wall_vert4);
...
void Game::initHiddenObjects() {
	...
	this->spawnZone->setPosition(10, 200);
...
void Game::updatePlatforms() {
	...
	for (auto it = begin (this->wall_platform_pointers); it != end (this->wall_platform_pointers); ++it) {
		(*it)->update();
	}
}
...
void Game::failure() {
	...
	this->display_text.setFillColor(sf::Color::Black);
	json d;
	d["Event_Type"] = "Death";
	ev D = make_tuple(this->main_tl->getTime_Absolute(), d);
	this->EH->raiseEvent(D);
