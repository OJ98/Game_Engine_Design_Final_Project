...
Player::Player(EventHandler* EH, Timeline* T) {
	...
	this->shoot_position = sf::Vector2f(this->getPosition().x + 2 * this->getSize().x, this->getPosition().y);
	this->dash = false;
...
void Player::initTexture() {
    if (!this->texture.loadFromFile("../src/Resources/gun.png"))
	{
...
// Returns the current shooting position
sf::Vector2f Player::getShootingPos() {
